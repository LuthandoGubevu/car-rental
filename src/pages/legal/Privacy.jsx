...
export function Privacy() {
  return (
    <LegalLayout title="Privacy Policy" updated="3 September 2026">
      <p>
        FleetCare ("we", "us", "our") provides a monthly vehicle condition check platform used by rental and
      ...
      <p>
        This policy covers drivers/customers who use the FleetCare app, and fleet administrators who manage
      ...
      <ul>
        ...
        <li>To maintain a verifiable, timestamped record that protects both drivers and fleet operators in disputes about vehicle condition.</li>
      ...
      <ul>
        <li>Your fleet company's administrators can see your submissions, vehicle details, and incident reports, since that's the purpose of the service.</li>
        <li>FleetCare staff may access data only to provide support or maintain the platform, never to sell or share it with third parties for marketing.</li>
      ...
      <p>To exercise any of these rights, contact us at <strong>privacy@fleetcare.co.za</strong>.</p>
      ...
      <h2>10. Contact us</h2>
      <p>Questions about this policy: <strong>privacy@fleetcare.co.za</strong></p>
    </LegalLayout>
  );
}
